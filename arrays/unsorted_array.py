...
class UnsortedArray:
    ...
    def max_in_array(array):
        '''
        Find the largest value in an unsorted array
        
        Parameters:
            array: the array to be searched
        
        Returns:
            int: index of max value
            int: max value in array
        '''
        if len(array) == 0:
    ...
    def min_in_array(array):
        '''
        Find the smallest value in an unsorted array
        
        Parameters:
            array: the array to be searched
        
        Returns:
            int: index of min value
            int: min value in array
        '''
        if len(array) == 0:
    ...
    def max_and_min_in_array(array):
        '''
        Find the largest and smallest value in an unsorted array
        ...
        '''
        if len(array) == 0:
            raise Exception("Max and min of an empty array")
        min_index = 0
        max_index = 0
        for index in range(1, len(array)):
            if array[index] > array[max_index]:
            ...
            if array[index] < array[min_index]:
                min_index = index
        return "Max:", max_index, array[max_index], "Min:", min_index, array[min_index]
